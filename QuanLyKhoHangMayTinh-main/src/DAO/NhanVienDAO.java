...
public class NhanVienDAO {
    ...
    public boolean updateTrangthai(String tk, int trangthai) {
        boolean ketQua = false;
        try {
            java.sql.Connection con = JDBCUtil.getConnection();
            // Đặt trạng thái của người dùng thành 0 để đánh dấu là đã bị xóa
            String deleteSql = "UPDATE nguoidung SET trangthai = ? WHERE taikhoan = ? and trangthai = 1";
            PreparedStatement deleteStmt = con.prepareStatement(deleteSql);
             deleteStmt.setInt(1, trangthai); 
             deleteStmt.setString(2, tk);
    ...
    public boolean delete(String tk) {
        ...
        try {
            ...
            String deleteSql = "DELETE FROM nguoidung WHERE taikhoan = ?";
            PreparedStatement deleteStmt = con.prepareStatement(deleteSql);
    ...
    public boolean capNhatChucVuNguoiDung(String taiKhoan, int maChucVuMoi, String tenchucvu, int manhomquyen, Date ngayThayDoi, lsChucVuDTO lscv) {
        boolean result = false;
        ...
        try {
            ...
            String sqlUpdateNguoiDung = "UPDATE nguoidung SET machucvu = ?, tenchucvu = ?, manhomquyen = ? WHERE taikhoan = ?";
            PreparedStatement st3 = con.prepareStatement(sqlUpdateNguoiDung);
            st3.setInt(1, maChucVuMoi);
            st3.setString(2, tenchucvu);
            st3.setInt(3, manhomquyen);
            st3.setString(4, taiKhoan);
            st3.executeUpdate();
