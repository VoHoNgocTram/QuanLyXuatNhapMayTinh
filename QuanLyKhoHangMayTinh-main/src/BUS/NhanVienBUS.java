...
//        // Mã hóa mật khẩu
    ...
    public String updateNguoiDung(String tk, int trangthai){
        if(nvDAO.updateTrangthai(tk, trangthai))
    ...
    public boolean capNhatChucVuNguoiDung(String taiKhoan, int maChucVuMoi, String tenchucvu, int manhomquyen, Date ngayThayDoi, lsChucVuDTO lscv){
        ...
        return nvDAO.capNhatChucVuNguoiDung(taiKhoan, maChucVuMoi, tenchucvu,manhomquyen, ngayThayDoi, lscv); 
