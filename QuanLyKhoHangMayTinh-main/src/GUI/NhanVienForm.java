...
//        });
    ...
    public void loadDataToTable() {
        try {
            String Hoatdong = "Nghỉ việc"; 
            String Hoatdong1 = "Đang làm"; 
            String Hoatdong2 = "Đang nghỉ"; 
            ...
            for (NguoiDungDTO i : nv) {
                if(i.getTrangThai()==1){
                    tblModel.addRow(new Object[]{
                        i.getTaiKhoan(), i.getHoTen(), i.getGioiTinh(), i.getNgaySinh(), i.getSdt(), i.getDiaChi(), Hoatdong1
                    });
                }else if(i.getTrangThai()==0){
                    tblModel.addRow(new Object[]{
                        i.getTaiKhoan(), i.getHoTen(), i.getGioiTinh(), i.getNgaySinh(), i.getSdt(), i.getDiaChi(), Hoatdong
                    });
                }else if(i.getTrangThai()==2){
                    tblModel.addRow(new Object[]{
                        i.getTaiKhoan(), i.getHoTen(), i.getGioiTinh(), i.getNgaySinh(), i.getSdt(), i.getDiaChi(), Hoatdong2
                    });
                }
            }
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (i_row == -1) {
            ...
            int trangthaiHienTai = nv.getTrangThai();
            String[] luaChon;

            // Xác định các trạng thái được phép chọn
            if (trangthaiHienTai == 1) {
                luaChon = new String[] { "0 - Nghỉ việc", "2 - Đang nghỉ" };
            } else if (trangthaiHienTai == 2) {
                luaChon = new String[] { "0 - Nghỉ việc", "1 - Đang làm" };
            } else if (trangthaiHienTai == 0) {
                luaChon = new String[] { "1 - Đang làm", "2 - Đang nghỉ" };
            }
            else {
                JOptionPane.showMessageDialog(this, "Không thể xoá với trạng thái hiện tại.");
                return;
            }

            String chonTrangThai = (String) JOptionPane.showInputDialog(
                this,
                "Chọn trạng thái mới:",
                "Cập nhật trạng thái",
            ...
            if (chonTrangThai != null) {
                int trangthaiMoi = Integer.parseInt(chonTrangThai.substring(0, 1));

                int confirm = JOptionPane.showConfirmDialog(this,
                    "Bạn có chắc chắn muốn cập nhật trạng thái nhân viên này?",
                    "Xác nhận",
                    JOptionPane.YES_NO_OPTION);
