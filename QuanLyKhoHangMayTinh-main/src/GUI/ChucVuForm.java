 ...
 * @author downny
 */
public class ChucVuForm extends javax.swing.JInternalFrame {
    ...
    public ChucVuForm(NguoiDungDTO user) {
    ...
    private void authorizeAction(NguoiDungDTO user) {
        ...
        try {
            allowedActions = ctqBUS.getAllowedActions(user.getMaNhomQuyen(), "chucvu");
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(ChucVuForm.this, "Lỗi kết nối cơ sở dữ liệu", "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
            return;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(ChucVuForm.this, "Lỗi không xác định", "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
            return;
        }
    ...
    public void loadDataToTable() {
        try {
            ArrayList<ChucVuDTO> cv = new ArrayList<ChucVuDTO>();
            cv = cvBUS.getAllDanhSachChucVu();
            tblModel.setRowCount(0);
            for (ChucVuDTO i : cv) {
                tblModel.addRow(new Object[]{
                    i.getMaChucVu(), i.getTenChucVu(), i.getLuongCoBan() + " đ"
                });
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ChucVuDTO getChucVuSelect() {
        int i_row = tblChucVu.getSelectedRow();
        ChucVuDTO cv = ChucVuDAO.getInstance().getAllDanhSachChucVu().get(i_row);
        return cv;
    }
    
    private void loadDataToTableSearch(ArrayList<ChucVuDTO> result) {
        try {
           
            tblModel.setRowCount(0);
            for (ChucVuDTO i : result) {
                tblModel.addRow(new Object[]{
                    i.getMaChucVu(), i.getTenChucVu(), i.getLuongCoBan()
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        cbxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã chức vụ", "Tên chức vụ" }));
        ...
        tblChucVu.setFont(new java.awt.Font("SF Pro Display", 0, 15)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        a.setVisible(true);*/
        AddChucVu a = new AddChucVu(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
        a.setVisible(true);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
       if (tblChucVu.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn chức vụ muốn sửa");
        } else {
            UpdateChucVu up = new UpdateChucVu(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
            up.setVisible(true);
        }
    ...
    private void txtSearchFormKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchFormKeyReleased
        ...
        switch (luaChon) {
            case "Tất cả":
                result = SearchChucVu.getInstance().searchTatCa(searchContent);
                break;
            case "Mã chức vụ":
                result = SearchChucVu.getInstance().searchMaChucVu(searchContent);
                break;
            case "Tên chức vụ":
                result = SearchChucVu.getInstance().searchTenChucVu(searchContent);
                break;
        }
