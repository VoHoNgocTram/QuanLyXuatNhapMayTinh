 ...
 * @author Acer
 */
public class UpDateBL extends javax.swing.JFrame {
...
//        LocalDate TGT = LocalDate.now();
    ...
    UpDateBL(String maBL, String taiKhoan, String hoTen, int luongCoBan, int luongTru, int tongLuong, String ngayTinhLuong, int SNC, int trangThai) {
        initComponents();
        //        txtMaBL.setText(maBL);
        lblTaikhoan.setText(taiKhoan);
        lblHoten.setText(hoTen);
        lblLCB.setText(String.valueOf(luongCoBan));
        lblLT.setText(String.valueOf(luongTru));
        lblTL.setText(String.valueOf(tongLuong));
        lblTGT.setText(ngayTinhLuong);
        lblNCTT.setText(String.valueOf(SNC));
//        cboTrangThai.setSelectedItem(trangThai == 1 ? "Đang hoạt động" : "Ngưng");
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpDateBL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
